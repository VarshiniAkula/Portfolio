            ...
            <Reveal direction="up" delay={0.3} className="space-y-12 pl-4">
              ...
              <div className="space-y-4">
                ...
                <a
                  ...
                  className="group inline-flex items-center gap-3 bg-[#00F2FF] text-black font-label font-bold py-3 px-6 rounded-full hover:brightness-110 hover:-translate-y-0.5 hover:shadow-[0_0_16px_2px_rgba(0,242,255,0.3)] active:scale-95 transition-all duration-300"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
